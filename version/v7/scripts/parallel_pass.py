#!/usr/bin/env python3
"""
parallel_pass.py - Centralized OpenMP parallelization pass for IR v7
...
(codegen_v7.py) never reads these annotations. They are written into the
...
As part of build pipeline:
    python build_ir_v7.py ... --parallel
