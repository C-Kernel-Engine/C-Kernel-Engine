#!/usr/bin/env python3
"""
Long-decode stability validator for v7 model matrix.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="v7 long decode stability matrix")
    ...
    print("=" * 120)
    print("v7 LONG DECODE STABILITY REPORT")
    print("=" * 120)
