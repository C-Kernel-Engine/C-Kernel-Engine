#!/usr/bin/env python3
"""
Generate profile_summary.json from profile_decode.csv for v6.6.

This is used when profiling through ck-cli-v6.6 (pure C runtime), where
ck_run_v6_6.py is not the execution path and therefore does not auto-emit
summary JSON.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate v6.6 profile summary JSON from CSV")
