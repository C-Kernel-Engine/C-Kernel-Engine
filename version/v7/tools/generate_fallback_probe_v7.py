...
Does NOT modify: export_attention.py, prepare_run_viewer.py, or any core
pipeline script. It just creates a file that the existing --probe flag reads.

Usage:
    python3 version/v7/tools/generate_fallback_probe_v7.py <run_dir>
    python3 version/v7/tools/generate_fallback_probe_v7.py <run_dir> --num-probes 4
    python3 version/v7/tools/generate_fallback_probe_v7.py <run_dir> --force
...
def main() -> int:
    ...
    report = {
        "source": "generate_fallback_probe_v7.py",
