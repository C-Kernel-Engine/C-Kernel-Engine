...
Usage:
    python version/v6.6/scripts/parity/compare_activations.py [--ck-dir DIR] [--llama-dir DIR] [--tol TOL]

Example:
    python version/v6.6/scripts/parity/compare_activations.py \
        --ck-dir ~/.cache/ck-engine-v6.6/models/.../ck_build/ck_parity_dumps \
