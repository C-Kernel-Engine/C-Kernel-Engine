/**
 * @file qwen2_int8.c
 * @brief AUTO-GENERATED: qwen2_0.5b_decode Implementation (IR v6.6 - Explicit Unrolled)
 *
...
#error "qwen2_0.5b_decode: v6.6 codegen currently supports fp32 only. Use --dtype=fp32."
#endif
