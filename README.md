...
| Qwen3.8 Flash Next 120B-A6B | `/path/to/qwen3.8-flash-next-q4_k_m.gguf` | Experimental 160 GB-class text lane (hyper-connections, sparse attention, 512-expert MoE); use the exact Flash quickstart and evidence boundary in the v8 runbook |
