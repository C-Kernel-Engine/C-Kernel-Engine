...
File: `scripts/v6.5/build_ir_v6.py`
...
File: `scripts/v6.5/codegen_v6.py`
...
| `scripts/v6.5/build_ir_v6.py` | Add Q8_0 buffer dtype |
| `scripts/v6.5/codegen_v6.py` | INT8 codegen path |
| `scripts/v6.5/ck_run_v6.py` | `--int8-activations` flag |
