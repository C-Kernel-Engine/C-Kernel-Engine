#!/usr/bin/env python3
"""
Verify v6 decode codegen writes K/V directly into the cache (no kv_cache_write).
"""
...
def test_codegen_decode_direct_cache() -> None:
    layout = build_layout()
    ...
    assert "kv_cache_write_head_major" not in code
    assert "direct-to-cache" in code
    assert "attention_forward_decode_head_major_gqa_flash" in code


if __name__ == "__main__":
    test_codegen_decode_direct_cache()
    print("v6 decode codegen direct-to-cache test passed.")
