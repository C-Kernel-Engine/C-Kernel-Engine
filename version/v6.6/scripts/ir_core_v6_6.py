# ============================================================================
# ORIGIN: Copied from v4/build_ir_v4.py for v6.6 independence
# PURPOSE: HF model conversion and weight inspection utilities
# NOTE: Compatibility layer - consider migrating functionality to v6.6 native
# ============================================================================
...
def emit_c_header(layout: ModelLayout, path: str, extra_api: str = "") -> None:
    ...
    Generates everything that codegen_v6_6.py expects:
...
def parse_args(argv: List[str]) -> Dict:
    ...
    args = {
        ...
        "codegen": "v4",  # Codegen version: v4 (default) or v6 (explicit unrolled)
        # Training options
...
def print_usage():
    ...
    print("  --codegen=v4|v6         Codegen version (default: v4)")
