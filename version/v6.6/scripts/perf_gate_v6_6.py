#!/usr/bin/env python3
"""
v6.6 performance gate evaluator.
...
def resolve_budgets(family: str) -> Dict[str, float]:
    ...
    overrides = {
        "min_decode_tok_s": parse_env_float(
            f"CK_V66_PERF_{env_family}_MIN_DECODE_TOK_S",
            "CK_V66_PERF_MIN_DECODE_TOK_S",
        ),
        "min_ipc": parse_env_float(
            f"CK_V66_PERF_{env_family}_MIN_IPC",
            "CK_V66_PERF_MIN_IPC",
        ),
        "max_cache_miss_rate": parse_env_float(
            f"CK_V66_PERF_{env_family}_MAX_CACHE_MISS_RATE",
            "CK_V66_PERF_MAX_CACHE_MISS_RATE",
        ),
        "max_branch_miss_rate": parse_env_float(
            f"CK_V66_PERF_{env_family}_MAX_BRANCH_MISS_RATE",
            "CK_V66_PERF_MAX_BRANCH_MISS_RATE",
        ),
    }
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate v6.6 perf budgets")
