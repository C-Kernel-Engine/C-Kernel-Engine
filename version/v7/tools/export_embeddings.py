#!/usr/bin/env python3
"""
Export the token embedding matrix from a C-Kernel-Engine v7 run directory.
...
Usage:
    python3 version/v7/tools/export_embeddings.py <run_dir>
    python3 version/v7/tools/export_embeddings.py <run_dir> -o /tmp/my_emb.json
    python3 version/v7/tools/export_embeddings.py <run_dir> --checkpoint 300
    python3 version/v7/tools/export_embeddings.py <run_dir> --tensor output.weight

Examples:
    python3 version/v7/tools/export_embeddings.py \\
        ~/.cache/ck-engine-v7/models/train/toy_svg_atoms_ctx512_d64_h128

    python3 version/v7/tools/export_embeddings.py \\
        ~/.cache/ck-engine-v7/models/train/toy_svg_structured_atoms_ctx512_d64_h128 \\
        --vocab version/v7/data/generated/toy_svg_structured_atoms_vocab.json
"""
...
def main(argv=None):
    p = argparse.ArgumentParser(
        description="Export token embeddings from a v7 run dir to JSON for the dataset viewer.",
    ...
    p.add_argument("--vocab", metavar="VOCAB_JSON",
                   help="Optional spec vocab JSON to enrich token group labels "
                        "(e.g. version/v7/data/generated/toy_svg_atoms_vocab.json... "
