...
# Paths
CACHE_DIR = Path.home() / ".cache/ck-engine-v7/models/Qwen--Qwen2-0.5B-Instruct-GGUF"
V7_ROOT = Path(__file__).parent.parent
GENERATED_DIR = V7_ROOT / "src" / "generated"
    ...
    def load_files(self) -> bool:
        ...
        for base_dir in [self.model_dir, self.generated_dir]:
            ...
            if self.c_code is None:
                for c_name in ("ck-kernel-inference.c", "model_v7.c"):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Generated source directory (default: version/v7/src/generated)",
    )
