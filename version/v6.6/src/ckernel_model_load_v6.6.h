/*
 * ckernel_model_load_v6.6.h - Load BUMPWGT5 weights using manifest
 *
 * Provides model loading functions and weight buffer management.
 */

#ifndef CKERNEL_MODEL_LOAD_V6_6_H
#define CKERNEL_MODEL_LOAD_V6_6_H
...
/*
 * ck_load_weights_manifest_v66() - Load weights using manifest map
 *
...
#endif /* CKERNEL_MODEL_LOAD_V6_6_H */
