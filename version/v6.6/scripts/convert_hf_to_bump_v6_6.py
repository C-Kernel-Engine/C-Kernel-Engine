#!/usr/bin/env python3
"""
convert_hf_to_bump_v6.py

Convert HF Llama-style weights into a bump layout aligned with the v6 pipeline.
...
def main():
    ...
    with open(args.output, "w+b") as f:
        ...
        if args.bump_version == BUMP_VERSION_V5:
            ...
            # Build metadata
            created_by = f"convert_hf_to_bump_v6_6.py v{BUMP_VERSION_V5}"
