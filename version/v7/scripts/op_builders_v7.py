...
Related files: parse_template_v2.py, op_builders_auto.py, op_builders_hybrid_v7.py
Current pipeline uses: build_ir_v7.py with kernel maps directly.
=============================================================================

op_builders_v7.py - Op Builders for Template v2

Maps template operations (OpNode) to GraphIR Op objects with symbolic tensor names.

USAGE:
    from op_builders_v7 import build_op_from_template, OpContext
