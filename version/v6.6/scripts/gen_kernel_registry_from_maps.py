#!/usr/bin/env python3
"""
Generate a kernel registry from v6.6 kernel maps (JSON).

Usage:
  python3 version/v6.6/scripts/gen_kernel_registry_from_maps.py
  python3 version/v6.6/scripts/gen_kernel_registry_from_maps.py --dir version/v6.6/kernel_maps \
      --output version/v6.6/kernel_maps/KERNEL_REGISTRY.json
  python3 version/v6.6/scripts/gen_kernel_registry_from_maps.py --check
  python3 version/v6.6/scripts/gen_kernel_registry_from_maps.py --validate --strict
"""
...
def main() -> int:
    ...
    registry = {
        '_meta': {
            'description': 'Kernel registry generated from v6.6 kernel maps',
            'version': 'v6.6',
