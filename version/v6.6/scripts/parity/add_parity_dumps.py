...
Usage:
    python version/v6.6/scripts/parity/add_parity_dumps.py <model_v6_6.c> [--output <patched.c>]
...
def main():
    ...
    parser.add_argument('input', type=Path, help='Input model_v6_6.c file')
    ...
    print("Run with: CK_DUMP_ACTIVATIONS=1 ./ck-cli-v6.6 ...")
