#!/usr/bin/env python3
"""
Profile v6.6 inference using the compiled shared library.
Run with: python scripts/v6.6/profile_inference.py
Then use perf: perf record -g python scripts/v6.6/profile_inference.py
"""
...
MODEL_DIR = os.path.expanduser("~/.cache/ck-engine-v6.6/models/Qwen--Qwen2-0.5B-Instruct-GGUF")
