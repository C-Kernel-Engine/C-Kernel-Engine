...
function renderDataLabPanel(files) {
    ...
    const manifestSection = manifestEntries.length > 0 ? `
        <details style="margin-bottom:0.5rem;">
            <summary style="cursor:pointer;font-size:0.78rem;color:#6b7280;font-weight:600;letter-spacing:0.04em;user-select:none;padding:0.3rem 0;">
                ◦ MANIFESTS &amp; REGISTRY (${manifestEntries.length} entries — data catalogs, not training data)
            </summary>
            <div style="margin-top:0.4rem;">
                <table style="font-size:0.76rem;">
                    <thead><tr><th>Stage</th><th>Kind</th><th>Name</th><th style="text-align:right;">Rows</th><th>Note</th></tr></thead>
                    <tbody>
    ...
    root.innerHTML = `
        ...
        <div class="parity-section" style="margin-top:0.8rem;">
            ...
            <div style="font-size:0.74rem;color:#6b7280;margin-bottom:0.5rem;">Row-level roundtrip: original line → token IDs → decoded. Low exact-match rate signals tokenizer drift or encoding issues.</div>
