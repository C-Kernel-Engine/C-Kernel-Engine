#!/usr/bin/env python3
"""
codegen_v6.6.py - Explicit unrolled C source emitter for IR v6.6 layouts.
...
_ROOT_DIR = _SCRIPT_DIR.parents[2]  # src/v6.6/scripts -> src/v6.6 -> src -> C-Kernel-Engine
...
def emit_c_source_v66(layout: v3.ModelLayout,
                     output_path: str,
                     header_name: str,
                     mode: str,
    ...
    add(f" * @brief AUTO-GENERATED: {layout.name} Implementation (IR v6.6 - Explicit Unrolled)")
    add(f" *")
    ...
    add(f" *")
    add(f" * DO NOT EDIT - Regenerate with build_ir_v6.6.py or codegen_v6.6.py")
    add(f" */")
    add()
    ...
    add(f'#error "{layout.name}: v6.6 codegen currently supports fp32 only. Use --dtype=fp32."')
    add("#endif")
    add()
    ...
    def emit_prefill_impl() -> None:
        add("/* ============================================================================")
        add(" * EXPLICIT PER-LAYER PREFILL FUNCTIONS (v6.6 unrolled)")
        add(" * ============================================================================ */")
        add()
    ...
    if mode == "decode":
        add("/* ============================================================================")
        add(" * EXPLICIT PER-LAYER DECODE FUNCTIONS (v6.6 unrolled)")
        add(" * ============================================================================ */")
        add()
