  ...
  sudo env LD_LIBRARY_PATH="$LD_LIBRARY_PATH" \
      ...
      ./build/ck-cli-v6.5 \
      ~/.cache/ck-engine-v6.5/models/Qwen--Qwen2-0.5B-Instruct-GGUF/ck-kernel-inference.so \
      ~/.cache/ck-engine-v6.5/models/Qwen--Qwen2-0.5B-Instruct-GGUF/weights.bump \
  ...
  perf record -g ./build/ck-cli-v6.5 ...
  ...
  vtune -collect uarch-exploration -r vtune_ck_uarch -- ./build/ck-cli-v6.5 ...

  # Memory access analysis
  vtune -collect memory-access -r vtune_ck_memory -- ./build/ck-cli-v6.5 ...
  ...
  ./build/ck-cli-v6.5 --model Qwen -p "Hello" --max-tokens 20

  # List available models
  ./build/ck-cli-v6.5 --list
