...
| Cohere Transcribe 2B | Native short-audio E2E bring-up | The mixed FP16/FP32 BUMP path accounts for all 2,104 tensors and runs the 48-layer encoder plus 8-layer cross-attention decoder through CKE kernels. On the pinned 7.435-second fixture, CKE matches CrispASR's 32 generated token IDs and transcript exactly; long audio, timestamps, resampling, multilingual, quantized, and optimized execution remain open. |
