...
def main() -> int:
    ap = argparse.ArgumentParser(description="Dynamic v6.6 model matrix validator")
    ...
    print("=" * 140)
    print("v6.6 DYNAMIC MODEL MATRIX REPORT")
    print("=" * 140)
