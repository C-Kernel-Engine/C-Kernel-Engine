...
![CKE at a glance: one compiler turns GGUF and SafeTensors models into readable generated C runtimes across text, vision, and audio, with measured numerical evidence and per-op X-Ray introspection](assets/cke-overview.svg)
