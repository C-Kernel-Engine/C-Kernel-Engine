#!/usr/bin/env python3
"""
Strict v6.6 parity matrix validator (Gemma/Qwen2/Qwen3).
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Strict v6.6 parity matrix validator")
    ...
    print("=" * 156)
    print("v6.6 STRICT PARITY MATRIX REPORT")
    print("=" * 156)
