#!/usr/bin/env python3
"""Build a balanced probe contract for spec18 routing-first scene bundles."""
...
def build_contract(
    ...
    *,
    ...
    return {
        ...
        "title": "Spec18 Routing First Scene Bundle Probe",
        "dataset_type": "svg",
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Build a balanced probe contract for spec18 routing-first scene bundles.")
