...
Usage:
    ...
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py --input llama_dump --output llama_parity_dumps/dump.bin

    # Convert with dtype inference from filename patterns
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py --input llama_dump --output llama_parity_dumps/dump.bin --dtype-hint fp32

    # Generate index.json alongside dump
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py --input llama_dump --output llama_parity_dumps --index
"""
...
Examples:
    ...
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py -i llama_dump -o llama_parity_dumps/dump.bin

    # Convert with Gemma name mapping
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py -i llama_dump -o llama_parity_dumps/dump.bin --model gemma

    # Force fp16 dtype
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py -i llama_dump -o llama_parity_dumps/dump.bin --dtype fp16

    # Generate index.json for reference
    python version/v6.6/scripts/parity/llama_to_ckdmp_converter.py -i llama_dump -o llama_parity_dumps --index
        """
    )
