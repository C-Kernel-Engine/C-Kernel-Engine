#!/usr/bin/env python3
"""Build a balanced probe contract for spec15b system_diagram runs."""
...
def _pick_balanced_prompts(
    ...
    *,
    ...
    for prompt in prompts:
        ...
        groups[(layout, case_id)].append(prompt)
...
def build_contract(
    ...
    *,
    ...
    repairer: str | None = "spec15b_scene_bundle.v1",
) -> dict[str, Any]:
    ...
    return {
        ...
        "title": "Spec15b System Diagram Probe",
        "dataset_type": "svg",
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Build a balanced probe contract for spec15b system_diagram runs.")
    ...
    ap.add_argument("--repairer", default="spec15b_scene_bundle.v1", help="Optional registered repairer name")
