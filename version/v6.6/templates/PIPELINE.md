...
**Tool:** `op_builders_v6_6.py` (what we're building)
...
**Tool:** `v6_6_ir_lowering.py` (already exists)
...
**Problem:** Template gives us operation names, but `ir_types_v6_6.py` needs:
