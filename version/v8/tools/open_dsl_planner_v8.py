#!/usr/bin/env python3
"""
DSL Planner Visualizer Generator for C-Kernel-Engine v8
...
Usage:
    python3 version/v8/tools/open_dsl_planner_v8.py --run <run_dir>
    python3 version/v8/tools/open_dsl_planner_v8.py --run <run_dir> --output report.html
    python3 version/v8/tools/open_dsl_planner_v8.py --run <run_dir> --open
    python3 version/v8/tools/open_dsl_planner_v8.py --list

Examples:
    python3 version/v8/tools/open_dsl_planner_v8.py --run ~/.cache/ck-engine-v8/models/train/spec19_scene_bundle_l3_d192_h384_ctx768_r3c_cumulative_neighbors
    python3 version/v8/tools/open_dsl_planner_v8.py --list
"""
...
DEFAULT_CACHE = Path.home() / ".cache" / "ck-engine-v8" / "models" / "train"
...
def generate(run_dir: Path, output_path: Path | None = None, auto_open: bool = False):
    ...
    data = {
        ...
        "generated_by": "open_dsl_planner_v8.py",
...
def main():
    parser = argparse.ArgumentParser(
        description="DSL Planner Visualizer — C-Kernel-Engine v8",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    python3 version/v8/tools/open_dsl_planner_v8.py --list
    python3 version/v8/tools/open_dsl_planner_v8.py --run ~/.cache/ck-engine-v8/models/train/spec19_...
    python3 version/v8/tools/open_dsl_planner_v8.py --run spec19_scene_bundle_l3_d192_h384_ctx768_r3c_cumulative_neighbors
    python3 version/v8/tools/open_dsl_planner_v8.py --run spec19_... --open
    python3 version/v8/tools/open_dsl_planner_v8.py --run spec19_... --output ~/reports/spec19.html
        """,
    )
