#!/usr/bin/env python3
"""
Standalone detailed parity analysis for v6.6.
...
def load_parity_module():
    spec = importlib.util.spec_from_file_location("v66_parity_test", str(PARITY_TEST))
...
def main() -> int:
    ...
    ap.add_argument("--skip-ck-run", action="store_true", help="Reuse current ck_build outputs")
    ...
    model_c = model_dir / "model_v6_6.c"
