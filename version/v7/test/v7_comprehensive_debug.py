#!/usr/bin/env python3
"""
v7_comprehensive_debug_test.py - Debug v7 step by step

This test validates each layer operation independently to find
where the output diverges from expected values.

Usage:
    python v7_comprehensive_debug_test.py --stop-at 0    # Test just embedding
    python v7_comprehensive_debug_test.py --stop-at 5    # Test through layer 0 attention
    python v7_comprehensive_debug_test.py --verbose
"""
...
class V7DebugTester:
    """Comprehensive debug testing for v7."""
    ...
    def check_memory_consistency(self) -> Tuple[bool, str]:
        ...
        c_code_path = self.model_dir / "model_v7.c"
...
def main():
    parser = argparse.ArgumentParser(description="Comprehensive v7 debug test")
    parser.add_argument("--model-dir", type=Path,
                       default=Path.home() / ".cache/ck-engine-v7/models/Qwen--Qwen2-0.5B-Instruct-GGUF",
