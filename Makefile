...
.PHONY: v8-init v8-doctor v8-capture-artifacts v8-capture-artifacts-run v8-profile-dashboard v8-profile-dashboard-run \
	v8-compile-train-runtime v8-training-certify-fp32 v8-training-workflow-fp32 v8-training-matrix-fp32 v8-regression-fast v8-regression-full v8-regression-family
