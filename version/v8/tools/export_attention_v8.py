...
Usage:
    ...
    python3 version/v8/tools/export_attention_v8.py \\
        ~/.cache/ck-engine-v8/models/train/toy_svg_atoms_ctx512_d64_h128 --probe

    # Single custom prompt
    python3 version/v8/tools/export_attention_v8.py <run_dir> \\
        --prompt "[shape:circle][color:red][size:small]"

    # Limit number of sequences
    python3 version/v8/tools/export_attention_v8.py <run_dir> --probe --max-probes 4

    # Use a specific checkpoint
    python3 version/v8/tools/export_attention_v8.py <run_dir> --probe --checkpoint 300

    # See available tensors
    python3 version/v8/tools/export_attention_v8.py <run_dir> --list-tensors
"""
...
def main(argv=None):
    p = argparse.ArgumentParser(
        description="Export attention matrices from a v8 run to JSON for the dataset viewer.",
